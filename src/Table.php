...
namespace PowerOn\Database\ORM;
...
class Table {
     ...
     * @param \PowerOn\Database\ORM\Entity $entity Entidad a guardar
     * @return boolean
     */
     ...
     * @param \PowerOn\Database\ORM\Entity $entity La entidad a eliminar
     * @return boolean
     */
